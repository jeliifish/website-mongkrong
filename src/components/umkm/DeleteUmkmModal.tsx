    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-zinc-950/45 p-6 backdrop-blur-[2px]">
      ...
      <div className="relative z-10 w-full max-w-lg overflow-hidden border border-zinc-200 bg-white shadow-[0_24px_80px_rgba(15,23,42,0.18)]">
        ...
        <div className="space-y-5 px-8 py-7">
          <div
            className="h-40 w-full rounded-[1.5rem] bg-[linear-gradient(180deg,#d7e5d8_0%,#96c498_100%)] bg-cover bg-center"
          ...
          <div className="border border-zinc-200 bg-zinc-50 px-5 py-4">
            ...
            <p className="mt-2 text-base font-semibold text-zinc-950">{umkm.name}</p>
            <p className="mt-1 text-sm text-zinc-500">Pemilik: {umkm.owner}</p>
          </div>

          <p className="text-sm leading-7 text-zinc-600">
            Tindakan ini akan menghapus data UMKM dari daftar admin. Pastikan data yang
            dipilih memang ingin dihapus.
          </p>
        </div>
